...
import { useUser, useAuth, ClerkLoaded, SignedIn, UserButton, SignInButton } from "@clerk/nextjs";
...
interface HeaderData {
  topBar?: {
    enabled?: boolean;
    trustBadges?: Array<{ icon: string; text: string; link?: string }>;
    serviceLinks?: Array<{ label: string; url: string; isStoreLocator?: boolean }>;
  };
  logo?: {
    image?: any;
    alt?: string;
    ...
    return (
      <header className="bg-white shadow-sm">
        <div className="animate-pulse">
          <div className="hidden lg:block bg-gradient-to-r from-rose-50 via-pink-50 to-blue-50 border-b border-rose-100 py-2">
            <Container>
